...
var Instructions map[byte]*Instruction = map[byte]*Instruction{
	...
	0x87: &Instruction{0x87, 0, 0, false, false, Inline_None,  "loop_end"},
	...
	0x8A: &Instruction{0x8A, 0, 1, false, false, Inline_Label, "pop_string_to_addr"},
	...
	0xA0: &Instruction{0xA0, 2, 0,  true, false, Inline_None, "unknown_A0"},
	...
	0xAD: &Instruction{0xAD, 1, 0,  true, false, Inline_None, "absolute"},
	0xAE: &Instruction{0xAE, 1, 0,  true, false, Inline_None, "compare"},
	0xAF: &Instruction{0xAF, 0, 1,  true, false, Inline_None, "push_char"},

	0xB0: &Instruction{0xB0, 1, 0, false,  true, Inline_None,     "pop_char"},
	0xB1: &Instruction{0xB1, 1, 0, false,  true, Inline_None,     "to_hex_string"},
	0xB2: &Instruction{0xB2, 0, 0,  true, false, Inline_None,     "read_mic"},
	0xB3: &Instruction{0xB3, 7, 0, false, false, Inline_Word,     "unknown_B3"}, // inline is read in VM_ExecuteOpcode
	...
	0xCB: &Instruction{0xCB, 2, 0,  true, false, Inline_None,  "add"},
	0xCC: &Instruction{0xCC, 2, 0,  true, false, Inline_None,  "subtract"},
	0xCD: &Instruction{0xCD, 2, 0,  true, false, Inline_None,  "multiply"},
	0xCE: &Instruction{0xCE, 2, 0,  true, false, Inline_None,  "divide"},
	0xCF: &Instruction{0xCF, 1, 0,  true, false, Inline_None,  "negate"},

	0xD0: &Instruction{0xD0, 1, 0,  true, false, Inline_None, "modulo_B8"},
	0xD1: &Instruction{0xD1, 2, 0,  true, false, Inline_None, "read_controller"},
	0xD2: &Instruction{0xD2, 2, 0,  true, false, Inline_None, "unknown_D2"},
	0xD3: &Instruction{0xD3, 2, 0, false,  true, Inline_None, "unknown_D3"},
	...
	0xE0: &Instruction{0xE0, 2, 0,  true, false, Inline_None,  "modulo"}, // BUT DIFFERENT FROM 0xD0 BECAUSE REASONS
	...
	0xE3: &Instruction{0xE3, 1, 0,  true, false, Inline_None,  "long_load"},
	...
	0xEE: &Instruction{0xEE, 1, 0, false, false, Inline_Count, "call_switch"},
	...
	0xF5: &Instruction{0xF5, 0, 0,  true, false, Inline_None,  "halt_F5"},
	...
	0xF9: &Instruction{0xF9, 0, 0,  true, false, Inline_None,  "get_741"},
	0xFA: &Instruction{0xFA, 0, 0,  true, false, Inline_None,  "get_742"},
